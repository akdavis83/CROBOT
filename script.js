// Constants
const ACTIVE_TIME_MS = 500000;
const DEACTIVATION_TIME_MS = 7500;
...
function getWeather() {
	responseMessage.innerText = "The weather is really great, and I know you wanted the weather at your location, but that will have to do.";
	showResponse();
}
function getTime() {
	var today = new Date();
...
function showInspiration() {
	deactivateFelix();
	window.open("https://akdavis83.github.io/SentinelCRO/", "_blank");
}
